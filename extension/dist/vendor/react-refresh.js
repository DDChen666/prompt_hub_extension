import { injectQuery } from './vite-client.mjs.js';
...
const __hmr_import = (module) => import(/* @vite-ignore */ injectQuery(module, 'import'));

// For backwards compatibility with @vitejs/plugin-react.
var reactRefresh = { injectIntoGlobalHook };

export { __hmr_import, createSignatureFunctionForTransform, reactRefresh as default, getRefreshReg, injectIntoGlobalHook, registerExportsForReactRefresh, validateRefreshBoundaryAndEnqueueUpdate };
